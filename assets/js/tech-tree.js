...
function generate_required_tech(prerequisites) {
	...
	for(var i = 0; i < prerequisites.length; i++) {
		...
		var item = $('<img height="52" width="52">').attr('data-src', '../assets/img/' + tech.key + ".png").attr('class','left').attr("src","//:0");
        elem.append(item);
...
$(document).ready(function() {
	...
	let techs = techData.filter(function(tech) {
	    ...
	    return {
			...
			data: tech,
			innerHTML: '<div class="' + iconClass + ' lozad" data-background-image="../assets/img/' + key + '.png"></div>'
